...
define([
    ...
    var TicketdetailsView = Foobunny.BaseView.extend({
        ...
        uiEl: {
            ...
            '$spinner': '.spinner',
            '$priceCellBottom': '.pricecellbottom',
        ...
        processOpenTicket: function(evt) {
            ...
            if ($ticketContainerOpen && ticketId !== $ticketContainerOpen.attr('data-tid')) {
                ...
                if (EventHelper.showBuyerCost() && qty > 0) {
                    this.uiEl.$priceCellBottom.addClass('hide');
                    this.uiEl.$emptyTotal.removeClass('hide');
                    this.getBuyerCost(qty, function(buyerCostResponse) {
                        ...
                        self.uiEl.$emptyTotal.addClass('hide');
                        self.uiEl.$priceCellBottom.removeClass('hide');
                    });
                }
        ...
        updatePriceInfo: function(cost) {
            ...
            this.uiEl.$emptyTotal.addClass('hide');
        ...
        context: function() {
            return {
                ...
                hasTotalCostFeature: EventHelper.isDisplayTotalCost(),
