...
define([
    ...
    var SeatmapView = Foobunny.BaseView.extend({
        ...
        initialize: function(options) {
            ...
            this.subscribeEvent('eventlayout:enableSelectionByZone', this.selectByZone);
        ...
        // filterChange: to check to fire filterModel change
        selectByZone: function(filterChange) {
            ...
            this.publishEvent('seatmap:sectionSelected', filterChange);
        },
        ...
        // filterChange: to check to fire filterModel change
        sectionSelected: function(filterChange) {
            ...
            this.model.set(dataObj, {silent: !filterChange});
