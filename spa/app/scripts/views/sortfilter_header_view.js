...
define([
    ...
    'globals',
    'global_context',
    'i18n'], function(Foobunny, Hammer, EventHelper, FilterModel, PriceSliderView, QuantityFilterView, globals, gc, i18n) {
    'use strict';
    ...
    var SortFilterHeaderView = Foobunny.BaseView.extend({
        ...
        initialize: function() {
            ...
            this.initializeQuantityFilterDropDown();
            ...
            //Events-2089
            this.subscribeEvent('filterView:hidden', function(event) {
                this.switchFilterIcon(event);
                this.showQtyAndFilterBtn(event);
                this.hideFilterCloseIcon(event);
            });
        ...
        initializeQuantityFilterDropDown: function() {
            var urlParamQtyBtnCount,
                maxButtonCount,
                qtyFilterArgs,
                quantity_dropdown_selector,
                quantity_selection_config;

            this.filterPreSelectText = (EventHelper.isEnabledQuantitySelectorStyle_11_2016())? i18n.get('event.common.sortfilter.selector.quantity.alltickets.text') : i18n.get('event.common.ticketQty');

            if (EventHelper.isEnabledQuantitySelectorStyle_11_2016()) {
                quantity_dropdown_selector = '.evt-dropdown'; // selector for select drop down: mobile first

                quantity_selection_config = EventHelper.getQuantitySelectionConfig();
                this.dropDownFilterStyle = quantity_selection_config.cssClass;

                if (quantity_selection_config.filterType === 'list') {
                    quantity_dropdown_selector = '#sortfilter-qty-selector .select-dropdown';
                }

                urlParamQtyBtnCount = Number(EventHelper.getUrlQuery('qtyBtnCount'));
                ...
                qtyFilterArgs = {
                    el: quantity_dropdown_selector,
                    filterId: 'sortfilter-qty-dropdown',
                    filterClass: 'qty_content qty-filter-drop-down flex-item',
                    type: quantity_selection_config.filterType || 'select',
                    maxButtonCount: 5,
                    minButtonCount: 4,
                    navigation: false,
                ...
                this.subViews.quantityFilter = new QuantityFilterView(qtyFilterArgs);
            }
        },
        ...
        events: {
            ...
            'click #sortfilter-selector': 'openFilterTray', //Events-2089
            ...
            'click .qty-and-filter-ctr .sh-iconset-close': 'closeFilterTray', //Events-2089
        ...
        openFilterTray: function(evt) {
            ...
            //Events-2089 ABTest Variant
            this.hideQtyAndFilterBtn();
            this.showFilterCloseIcon();
        ...
        closeFilterTray: function(evt) {
            ...
            //Events-2089 ABTest Variant
            this.showQtyAndFilterBtn();
            this.hideFilterCloseIcon();

            this.switchFilterIcon(true);
            this.publishEvent('filter:hide');
        },

        hideQtyAndFilterBtn: function() {
            this.uiEl.$sortFilterSelectorTitle.removeClass('hide');
            this.uiEl.$sortFilterSelector.addClass('hide');
        },

        showQtyAndFilterBtn: function() {
            this.uiEl.$sortFilterSelectorTitle.addClass('hide');
            this.uiEl.$sortFilterSelector.removeClass('hide');
        },

        showFilterCloseIcon: function() {
            this.uiEl.$sortfilterCloseIcon.removeClass('hide');
        },

        hideFilterCloseIcon: function() {
            this.uiEl.$sortfilterCloseIcon.addClass('hide');
        },
        ...
        displayUpdatedQuantity: function(model, params) {
            ...
            if (this.subViews.quantityFilter) {
                this.subViews.quantityFilter.displaySelectedQty(qty);
            }
            if (qty > '0') {
        ...
        context: function() {
            return {
                ...
                dropDownFilterStyle: this.dropDownFilterStyle,
                isMobile: EventHelper.isMobile(), //Events-2089
                filterPreSelectText: this.filterPreSelectText, //Events-2089
