...
define([
    ...
    var TicketlistGAView = Foobunny.BaseView.extend({
        ...
        processFilterModelChanged: function(model) {
            ...
            //BugFix:Events-2145
            var priceType = (model.get('withFees') ? globals.price_type.CURRENT : globals.price_type.LISTING);
            model.setSilent({'priceType': priceType});
        ...
        setTicketlistHeight: function() {
            var windowHeight = $(window).height(),
                ...
                footerHeight = $('.bottom-wrapper').outerHeight(),
            ...
            this.$el.height(windowHeight - headerHeight - eventInfoHeight -
                qtyFilterHeight - singleTicketHeight - footerHeight);
        },
